...
////// Specular:
                ...
                float RimAllphaMultiply = ((saturate((sceneZ-partZ)/_RimDistance)-pow(saturate((sceneZ-partZ)/_RimSize),_Rimfalloff))*_RimColor.a);
